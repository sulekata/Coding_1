...
comparison <- htmlreg( list( linreg , sqreg, splinereg , weightreg ), type = 'html',
         custom.model.names = c( 'Linear', 'Quadratic',
                                'PLS','Weighted linear'), caption = 'Results of estimated models' )
comparison
```
